...
} from "./chunk-2C2QTARI.js";
import {
  Field,
  createCurve,
  createHasher,
  mapToCurveSimpleSWU
} from "./chunk-SGYMVRCU.js";
import {
...
var sha1 = createHasher4(() => new SHA1());
...
var ripemd160 = createHasher4(() => new RIPEMD160());
...
var gen = (suffix, blockLen, outputLen) => createHasher4(() => new Keccak(blockLen, suffix, outputLen));
...
function sha2565(value, options = {}) {
  const { as = typeof value === "string" ? "Hex" : "Bytes" } = options;
  const bytes = sha2564(from(value));
  if (as === "Bytes")
    return bytes;
  return fromBytes(bytes);
}
...
var HDKey = class _HDKey {
  ...
  static fromMasterSeed(seed, versions = BITCOIN_VERSIONS) {
    ...
    const I = hmac2(sha5123, MASTER_SECRET, seed);
    return new _HDKey({
      versions,
  ...
  deriveChild(index2) {
    ...
    const I = hmac2(sha5123, this.chainCode, data);
...
function mnemonicToSeedSync(mnemonic, passphrase = "") {
  return pbkdf2(sha5123, normalize2(mnemonic).nfkd, psalt(passphrase), { c: 2048, dkLen: 64 });
}
...
@noble/curves/esm/p256.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-PG44OWEW.js.map
