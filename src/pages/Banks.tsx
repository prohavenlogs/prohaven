...
import { BANKS } from "@/data/products";
...
const Banks = () => {
  ...
  const handlePurchase = async (productId: string, productName: string, price: number) => {
    await purchaseProduct(productId, productName, price, "Banks");
  };

  const filteredProducts = useMemo(() => {
    return BANKS.filter(product =>
        ...
        <div className="container mx-auto px-4 py-8 max-w-7xl">
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-4xl font-bold text-foreground">Banks</h1>
            </div>
            <p className="text-muted-foreground">Premium bank account logs with verified access</p>
          </div>
